        ...
        var appendIconListToBody = function (data, buttonShowAll, buttonCancel, searchPlaceholder, borderRadius, inputElement, previewElement, theCallback) {
            ...
            for (var key in jsonData) {
                if (jsonData.hasOwnProperty(key)) {
                    ...
                    var icon = '<i data-search="' + forObj + '" data-class="' + forObj + '" class="text-black first-icon select-icon ' + forObj + '"></i>';
                    icons += icon;
                }
            }
                    ...
                    for (var key in jsonData) {
                        if (jsonData.hasOwnProperty(key)) {
                            ...
                            if (forObj.toString().indexOf(searchVal) > -1) {
                                ...
                                var tempIcon = '<i data-search="' + forObj + '" data-class="' + forObj + '" class="text-black search-icon select-icon ' + forObj + '"></i>';
                                tempIcons += tempIcon;
                            }
                        }
                    }
                    ...
                    singleIconElm.addEventListener('click', function (e) {
                        ...
                        for (var i = 0; i < inputElm.length; i++) {
                            ...
                            if (getTagName === 'input' || getTagName === 'textarea') {
                                inputElm[i].value = iconClassName.replace("fa-3x", "").trim();
                            }
                            // else any of element
                            else {
                                inputElm[i].innerHTML = iconClassName.replace("fa-3x", "").trim();
                            }
