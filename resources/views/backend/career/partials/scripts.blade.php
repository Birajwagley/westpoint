...
<script>
    $(document).ready(function() {
        const table = $('#careerTable').DataTable({
            bSortCellsTop: true,
            scrollX: true,
            autoWidth: false,
            responsive: false,
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        const editUrl = "{{ route('career.edit', ':id') }}"
                            .replace(':id', data
                                .id);
                        const deleteUrl = "{{ route('career.destroy', ':id') }}"
                            .replace(':id',
                                data.id);
                        ...
                        return `
                                <div class="flex space-x-2">
                                    ...
                                    <x-buttons.delete-button url="${deleteUrl}" class="career-delete"/>
                                </div>
                            `;
                    }
                }
        ...
        // Delete Role
        $(document).on("click", ".career-delete", function(e) {
            e.preventDefault();
        ...
        $(document).on("change", ".is-published-toggle", function() {
            ...
            updateUrl = updateUrl.replace(':id', id).replace(':model', 'Career');
