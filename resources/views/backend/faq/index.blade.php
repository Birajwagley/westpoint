...
@section('headerWithButton')
    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-2 md:gap-3 lg:gap-4">
        ...
        <!-- Add Button -->
        <x-buttons.form-create-button route="{{ route('faq.create') }}" name="Faq" permission="faq" />
    </div>
@endsection
...
@section('content')
    <table id="faqTable" class="display" width="100%">
...
@section('scripts')
    @include('backend.faq.partials.scripts')
@endsection
