...
@section('headerWithButton')
    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-2 md:gap-3 lg:gap-4">
        ...
        <!-- Add Button -->
        <x-buttons.form-create-button route="{{ route('link.create') }}" permission="link" />
    </div>
@endsection
...
@section('content')
    <table id="linkTable" class="display table-auto" width="100%">
...
@section('scripts')
    @include('backend.link.partials.scripts')
@endsection
