...
@section('headerWithButton')
    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-2 md:gap-3 lg:gap-4">
        ...
        <!-- Add Button -->
        <x-buttons.form-create-button route="{{ route('page.create') }}" permission="page" />
    </div>
@endsection
...
@section('content')
    <table id="pageTable" class="display table-auto" width="100%">
...
@section('scripts')
    @include('backend.page.partials.scripts')
@endsection
