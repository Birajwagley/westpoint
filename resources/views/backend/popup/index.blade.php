...
@section('headerWithButton')
    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-2 md:gap-3 lg:gap-4">
        ...
        <!-- Add Button -->
        <x-buttons.form-create-button route="{{ route('popup.create') }}" name="Popup" permission="popup" />
    </div>
@endsection
...
@section('content')
    <table id="popupTable" class="display" width="100%">
...
@section('scripts')
    @include('backend.popup.partials.scripts')
@endsection
