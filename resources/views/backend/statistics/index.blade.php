...
@section('headerWithButton')
    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-2 md:gap-3 lg:gap-4">
        ...
        <!-- Add Button -->
        <x-buttons.form-create-button route="{{ route('statistic.create') }}" name="Statistics" permission="statistics" />
    </div>
@endsection
...
@section('content')
    <table id="statisticsTable" class="display" width="100%">
...
@section('scripts')
    @include('backend.statistics.partials.scripts')
@endsection
