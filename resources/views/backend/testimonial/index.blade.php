...
@section('headerWithButton')
    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-2 md:gap-3 lg:gap-4">
        ...
        <!-- Add Button -->
        <x-buttons.form-create-button route="{{ route('testimonial.create') }}" name="Team" permission="testimonial" />
    </div>
@endsection
...
@section('content')
    <table id="testimonialTable" class="display" width="100%">
...
@section('scripts')
    @include('backend.testimonial.partials.scripts')
@endsection
